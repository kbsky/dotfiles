...
" + some additions/modifications by Kevin Brodsky
...
syn match armasmIdentifier	"[a-zA-Z_$][a-zA-Z0-9_$]*"
syn match armasmLabel		"^\s*\.\?[a-zA-Z0-9_$]\+:"me=e-1
syn match armasmLabel		"^\.\?[a-zA-Z0-9_$]\+"
...
"Added: ASL (not sure it's standard, but gcc outputs it)
syn keyword armasmOpcode	NEG LSL LSR ASR ASL ROR RRX PUSH POP
